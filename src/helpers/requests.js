...
export function getAnalyzeStockUrl() {
...
export function deleteAllStocks() {
  ...
  .then(response => updateLastTimeUpdateDatabase({date: '"2019-01-02T00:00:00Z"'}))
  .catch(error => console.log(error))
}
